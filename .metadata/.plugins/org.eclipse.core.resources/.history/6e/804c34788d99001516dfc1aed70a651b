...
public class MobileCompanyService implements BaseEntityManager<MobileCompany> {
	...
	public void runMqttPushMobileCompany(String ownerUri, String userName, String httpServerHost, String httpServerPort, String mqttServerHost, String mqttServerPort, MobileCompany mobileCompany){
		JSONObject jsonObjectData = new JSONObject();
		
		jsonObjectData.put("cmd", "serverInformation");
		
		if(httpServerHost != null && !httpServerHost.equals("") && httpServerPort != null && !httpServerPort.equals("") && mqttServerHost != null && !mqttServerHost.equals("") && mqttServerPort != null && !mqttServerPort.equals("")){
			jsonObjectData.put("httpServerHost", httpServerHost);
			jsonObjectData.put("httpServerPort", httpServerPort);
			jsonObjectData.put("mqttServerHost", mqttServerHost);
			jsonObjectData.put("mqttServerPort", mqttServerPort);
		}
