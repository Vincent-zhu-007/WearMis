...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" style="padding: 5px;">
		...
		<form id="tableForm" name="tableForm">
			...
			<input type="hidden" id="mobileRole" name="mobileRole" />
			<div class="custtop">
				<ul>
					<%if(op.equals("add")){ %>
					<li>
						...
						<span class="inputlable">
							<input id="ownerUri" name="ownerUri" class="easyui-validatebox" data-options="required:true,validType:{
								length:[0,50],
								remote:['${ctx}/mobileUser.do?method=ownerUriIsExist','ownerUri']
					...
					<li>
						...
						<span class="inputlable">
							<input id="userName" name="userName" class="easyui-validatebox" data-options="required:true,validType:{
								length:[0,40],
								remote:['${ctx}/mobileUser.do?method=userNameIsExist','userName']
					...
					<li>
						<span class="textlable">终端号码：</span>
						<span class="inputlable">
	...
	$(function() {
		...
		$("#tableForm").form({
			...
			onSubmit : function() {
				...
				window.parent.$("#mobileRole").val(mobileRole);
