		...
		<form id="tableForm" name="tableForm">
			...
			<div class="custbottom">
				<span class="custbottom_title">
					权限列表
					<a href="javascript:;" onclick="clearMenuConfigCache()">重置终端权限缓存</a>
				</span>
				<ul id="mobileRoleMenu"></ul>
			</div>
		</form>
	</div>
...
<script type="text/javascript">
	$(function() {
		...
		$("#tableForm").form({
			url : "",
			onSubmit : function() {
				var nodes = window.parent.$("#mobileRoleMenu").tree('getChecked');
				var permission = "";
	...
	function cancel() {
		$("#mobileRoleModalWindow").window("destroy");
	}
</script>
