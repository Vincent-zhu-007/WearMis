		...
		<form id="tableForm" name="tableForm">
			...
			<div class="custbottom">
				<span class="custbottom_title">
					权限列表
					<a href="javascript:;" onclick="clearWebSiteMenuConfigCache()">重置平台权限缓存</a>
				</span>
				<ul id="webSiteRoleMenu"></ul>
			</div>
		</form>
	</div>
...
<script type="text/javascript">
	$(function() {
		...
		$("#tableForm").form({
			url : "",
			onSubmit : function() {
				var nodes = window.parent.$("#webSiteRoleMenu").tree('getChecked');
				var permission = "";
	...
	function cancel() {
		$("#webSiteRoleModalWindow").window("destroy");
	}
</script>
