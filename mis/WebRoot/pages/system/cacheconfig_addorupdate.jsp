	...
	<div data-options="region:'center',border:false" style="padding: 5px;">
		...
		<form id="tableForm" name="tableForm">
			...
			<ul style="width: 280px;">
				<%if(op.equals("add")){ %>
				<li>
					<span class="textlable">缓存编码：</span>
					<span class="inputlable">
						<input id="codeName" name="codeName" class="easyui-validatebox" data-options="required:true,validType:{
								length:[0,50],
								remote:['${ctx}/cacheConfig.do?method=isExist','codeName']
							},invalidMessage:'缓存编码已经存在或名称超过50个字符'" />
					</span>
				</li>
				<%} %>
				
				<li>
					<span class="textlable">缓存描述：</span>
					<span class="inputlable">
						<input type="text" id="description" name="description" data-options="required:true" />
					</span>
				</li>
				
				<li>
					<span class="textlable">清除地址：</span>
					<span class="inputlable">
						<input type="text" id="clearUrl" name="clearUrl" data-options="required:true" />
					</span>
				</li>
