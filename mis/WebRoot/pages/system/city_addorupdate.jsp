	...
	<div data-options="region:'center',border:false" style="padding: 5px;">
		...
		<form id="tableForm" name="tableForm">
			...
			<ul style="width: 280px;">
				...
				<li>
					...
					<span class="inputlable">
						<input id="codeName" name="codeName" class="easyui-validatebox" data-options="required:true,validType:{
								length:[0,50],
								remote:['${ctx}/city.do?method=isExist','codeName']
				...
				<li>
					<span class="textlable">省级：</span>
					<span class="inputlable">
						<input id="provinceCodeName" name="provinceCodeName" data-options="required:true" />
					</span>
				</li>
...
<script type="text/javascript">
	...
	function cancel() {
		$("#cityModalWindow").window("destroy");
	}
</script>
